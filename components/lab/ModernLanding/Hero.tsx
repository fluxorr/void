...
const Hero = () => {
    return (
        <div className="flex flex-col relative justify-between items-center mt-12 mx-28 h-[85vh]  " >
            ...
            <h1 className="font-crimson-text tracking-tighter text-[160px] " >Browse everything</h1>
            ...
            >
                <Image draggable="false" src={ScreenImage} className="  z-10 h-[580px] w-[980px] rounded-t-[16px]  " alt="Product demo image" ></Image>
            </motion.div>
